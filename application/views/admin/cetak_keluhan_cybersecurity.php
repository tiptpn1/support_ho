                ...
                <table width="100%" border="1" bordercolor="#000000">
                    <tr>
                        <td width="31%" align="center">PT Perkebunan Nusantara I<br />
                            <?php echo $this->m_kelola_tiket_cybersecurity->ambil_nama_kantor($data->id_ajukan)->row()? $this->m_kelola_tiket_cybersecurity->ambil_nama_kantor($data->id_ajukan)->row()->alamat_kantor : '' ?>
                        </td>
                        ...
                        <td width="30%" class="style17">
                            <table>
                                <tr>
                                    <td>No</td>
                                    <?php
                                    //$kelola_tiket = $this->M_kelola_tiket_cyberm_kelola_tiket_cybersecurity->tampil_kelola_tiket()->result();
                    ...
                    <font color="#000000">
                        <table width="100%">
                            ...
                            <tr>
                                <td>
                                    <table>
										<?php if (!$data->is_anonymous) { ?>
                                        <tr>
                                            <td>Bagian</td>
                                            <td>: <?php echo $this->m_kelola_tiket_cybersecurity->ambil_nama_bagian($data->id_ajukan)->row()->bagian ?></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Pemohon</td>
                                            <td>: <?= $data->nama ?></td>
