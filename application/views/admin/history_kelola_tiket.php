...
<head>
  <?php $this->load->view("admin/navigation_admin.php", array('page' => 'history_kelola_tiket')) ?>
</head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">History Pengelolaan Tiket</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <table id="history-datatables-tiket" class="table table-bordered table-hover" data-url="<?= base_url('panel/get_history_tiket'); ?>">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Kode servis</th>
