  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Master Group Perangkat</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <form role="form" id="" method="post" action="<?php echo base_url() . 'Panel/tambah_aksi_mstrgroup_perangkat' ?>">
            <div class="card-body">
              <div class="form-group">
                <label>Nama Group Perangkat*</label>
