...
<head>
  <?php $this->load->view("admin/navigation_admin.php", array('page' => 'kelola_tiket_cybersecurity')) ?>
</head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pengelolaan Tiket Cybersecurity</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <table id="datatables-tiket-cybersecurity" class="table table-bordered table-hover" data-url="<?= base_url('panel/get_tiket_cybersecurity'); ?>">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Kode servis</th>
        ...
        <div class="modal-body modal-pdf">
          <script type="text/javascript">
            $(document).on("click", ".pilih-modal", function() {
              ...
              $('.modal-pdf').html('<embed src="<?php echo base_url('ajax/print_formkeluhan_cybersecurity?id_ajukan=') ?>' + id +
...
<footer>
  ...
  <?php }
  if ($this->session->flashdata('validDelete')) { ?>
    <script type="text/javascript">
      Swal.fire({
