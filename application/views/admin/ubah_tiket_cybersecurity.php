...
<head>
	<?php $this->load->view("admin/navigation_admin.php", array('page' => 'ubah_tiket_cybersecurity')) ?>
	...
	<div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0 text-dark">Ubah Tiket Keluhan Cybersecurity</h1>
					</div><!-- /.col -->
				</div><!-- /.row -->
			</div><!-- /.container-fluid -->
		</div>
			...
			<div class="row">
				<div class="col-12">
					...
					<div class="card card-info">
						<!-- form start -->
						<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'Panel/ubah_aksi_tiket_cybersecurity'; ?>">
                  ...
                  <div class="col-sm-10" align="left">
                    <input type="text" class="form-control col-md-10" name="tgl" id="datetimepicker" value="<//?= $kelola_tiket->tanggal ?>" required>
								...
								<?php if (!$kelola_tiket->is_anonymous) { ?>
									<div class="form-group row">
