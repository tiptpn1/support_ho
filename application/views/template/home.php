            ...
            <form class="appointment-form ftco-animate" enctype="multipart/form-data" method="post" action="<?php echo base_url() . 'user/tambah_aksi_ajukan' ?>">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-9">
                    <input type="text" class="form-control" name="hp" placeholder="Masukkan Nomor Hp" autocomplete="off" value="<?php echo $this->session->flashdata('hp') ?>" required>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-9">
                    <textarea name="uraian_kerusakan" id="" cols="30" rows="5" class="form-control" placeholder="Masukkan Uraian Permasalahan" required><?php echo $this->session->flashdata('uraian') ?></textarea>
                  </div>
                </div>
              </div>
              <div class="form-group">
